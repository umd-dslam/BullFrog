...
/* Number of partitions of the shared migrateagg hashtable */
#define NUM_MIGRATE_AGG_PARTITIONS 256
...
#define MIGRATE_AGG_OFFSET \
	(PREDICATELOCK_MANAGER_LWLOCK_OFFSET + NUM_PREDICATELOCK_PARTITIONS)
#define NUM_FIXED_LWLOCKS	\
	(MIGRATE_AGG_OFFSET + NUM_MIGRATE_AGG_PARTITIONS)
