...
/* Number of partitions of the shared migratejoin hashtable */
#define NUM_MIGRATE_JOIN_PARTITIONS 256
...
#define MIGRATE_JOIN_OFFSET \
	(PREDICATELOCK_MANAGER_LWLOCK_OFFSET + NUM_PREDICATELOCK_PARTITIONS)
#define NUM_FIXED_LWLOCKS	\
	(MIGRATE_JOIN_OFFSET + NUM_MIGRATE_JOIN_PARTITIONS)
